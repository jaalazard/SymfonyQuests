 ...
 */
final class Version20230603114049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program CHANGE country country VARCHAR(255) DEFAULT NULL, CHANGE year year INT DEFAULT NULL');
    }
